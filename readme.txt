...
3. Enter the of FYS courses offered.
...
Known Bugs:
•	Does not properly sort into the desired classes, even though algorithm checks.
•	Does not properly count the enrollment of students.
•	Does not output the student id’s properly for each class, has commas instead.
